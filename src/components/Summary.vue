<template>
  <section
    class="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-8 mb-12 border-l-4 border-orange-500 transition-colors duration-300"
  >
    <h3
    ...
    <div class="mt-4 text-neutral-600 dark:text-neutral-300">
      <p>{{ $t('summaryP2') }}</p>
    </div>
  </section>
</template>
